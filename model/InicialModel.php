...
class InicialModel extends ConexionBD
{
    // Método para obtener información de la boda por id de formato
    public function obtenerInicialPor($idFormato)
    {
        // Consulta SQL para obtener la información de la boda
        $query = "SELECT * FROM paquetes WHERE id_formato_inicial = :idFormato";
    ...
    public function obtenerInicialPorID($id)
    {
        // Consulta SQL para obtener la información de la boda
        $query = "SELECT * FROM tipo_inicial WHERE id = :id";
