...
class PrimariaModel extends ConexionBD
{
    // Método para obtener información de la boda por id de formato
    public function obtenerPrimariaPor($idFormato)
    {
        // Consulta SQL para obtener la información de la boda
        $query = "SELECT * FROM paquetes WHERE id_formato_primaria = :idFormato";
    ...
    public function obtenerPrimariaPorID($id)
    {
        // Consulta SQL para obtener la información de la boda
        $query = "SELECT * FROM tipo_primaria WHERE id = :id";
