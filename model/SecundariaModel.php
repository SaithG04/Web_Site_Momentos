...
class SecundariaModel extends ConexionBD
{
    // Método para obtener información de la boda por id de formato
    public function obtenerSecundariaPor($idFormato)
    {
        // Consulta SQL para obtener la información de la boda
        $query = "SELECT * FROM paquetes WHERE id_formato_secundaria = :idFormato";
    ...
    public function obtenerSecundariaPorID($id)
    {
        // Consulta SQL para obtener la información de la boda
        $query = "SELECT * FROM tipo_secundaria WHERE id = :id";
