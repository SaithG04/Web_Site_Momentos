...
session_start();
$_SESSION['tipo_inicial'] = $_GET['tipo_inicial'];

$datosInicial = new InicialModel();
$datos = $datosInicial->obtenerInicialPorID($_GET['tipo_inicial']);
...
<body>
    ...
    <div class="container">
        <form action="../controller/PedidoInicialController.php" method="post" onsubmit="return validarFecha()">
    ...
    <script>
        ...
        function redireccionar() {
            ...
            window.location.href = 'SeleccionarTipoInicial.php';
        }
    </script>
