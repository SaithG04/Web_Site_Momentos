...
<body>
        ...
        <li class="menu-icon" onclick="toggleMenu()">
          ...
          <div class="overlay" id="overlay">
            <div class="menu-content" id="menuContent">
              ...
              session_start();
              $_SESSION["redirect_url"] = "../view/SeleccionarTipoQuino.php";
  ...
  <div class="container">
    <div class="row">
      <div class="column">
        ...
        <a href="javascript:void(0);" onclick="irARegistroQuino('QT1')"><img src="../resources/images/quino1.jpg" alt="Quino 1" class="image1"> </a>
        <a href="javascript:void(0);" onclick="irARegistroQuino('QT2')"><img src="../resources/images/quino2.jpg" alt="Quino 2" class="image2"></a>
      </div>
      <div class="column">
        <a href="javascript:void(0);" onclick="irARegistroQuino('QT3')"><img src="../resources/images/quino3.jpg" alt="Quino 3" class="image3"></a>
        <a href="javascript:void(0);" onclick="irARegistroQuino('QT4')"><img src="../resources/images/quino4.jpg" alt="Quino 4" class="image4"></a>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    // Función para redireccionar a RegistroBoda.php con parámetro
    function irARegistroQuino(tipo) {
      // Usa JavaScript para redirigir a la página y pasar el parámetro en la URL
      window.location.href = 'RegistroQuino.php?tipo_quino=' + tipo;
    }
  </script>
</body>
