...
$_SESSION['tipo_boda'] = $_GET['tipo_boda'];

$datosBoda = new BodaModel();
$datos = $datosBoda->obtenerBodaPorID($_GET['tipo_boda']);
...
<body>
    ...
    <div class="container">
        <form action="../controller/PedidoBodaController.php" method="post" onsubmit="return validarFecha()">
    ...
    <script>
        ...
        function redireccionar() {
            ...
            window.location.href = 'SeleccionarTipoBoda.php';
        }
    </script>
