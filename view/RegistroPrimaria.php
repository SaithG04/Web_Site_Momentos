...
$_SESSION['tipo_primaria'] = $_GET['tipo_primaria'];

$datosPrimaria = new PrimariaModel();
$datos = $datosPrimaria->obtenerPrimariaPorID($_GET['tipo_primaria']);
...
<body>
    ...
    <!-- Encabezado Página -->
    <div class="container">
        <form action="../controller/PedidoPrimariaController.php" method="post" onsubmit="return validarFecha()">
    ...
    <script>
        ...
        function redireccionar() {
            window.location.href = 'SeleccionarTipoPrimaria.php';
        }
    </script>
