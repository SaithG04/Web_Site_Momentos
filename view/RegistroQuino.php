...
$_SESSION['tipo_quino'] = $_GET['tipo_quino'];

$datosQuino = new QuinoModel();
$datos = $datosQuino->obtenerQuinoPorID($_GET['tipo_quino']);
...
<body>
    ...
    <!-- Encabezado Página -->
    <div class="container">
        <form action="../controller/PedidoQuinoController.php" method="post" onsubmit="return validarFecha()">
    ...
    <script>
        ...
        function redireccionar() {
            ...
            window.location.href = 'SeleccionarTipoQuino.php';
        }
    </script>
